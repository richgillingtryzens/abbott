          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="single-footer-widget">
                <h3>About Abbotts Private Care</h3>

                <div className="about-the-store">
                  <p>Supporting our happy customers.</p>
                  ...
                  <ul className="footer-contact-info">
                    ...
                    <li>
                      <i className='bx bx-phone-call'></i> 
                                            1800-225-311 (Toll Free Customer Service)
                    </li>
                    <li>
                      <i className='bx bx-envelope'></i> 
                                            customerserviceaustralia@abbott.com
                    </li>
                  </ul>
                </div>
          ...
          <div className="footer-bottom-area">
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-6">
                <p>
                                    Copyright <i className='bx bx-copyright'></i>{currentYear} <a href="https://aus.abbott" rel="noreferrer" target="_blank">Abbott</a> - All rights reserved. Please read legal notice for further details
                </p>
              </div>
