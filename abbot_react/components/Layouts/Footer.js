                    ...
                    <div className="footer-bottom-area">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6">
                                <p>
                                    Copyright <i className='bx bx-copyright'></i>{currentYear} <a href="https://aus.abbott" target="_blank">Abbott</a> - All rights reserved. Please read legal notice for further details
                                </p>
                            </div>
